...
export type ArrowsReloadProps = SVGProps<SVGSVGElement> & {
  /** Pixel size (width & height). Defaults to 24 to match Figma. */
  size?: number | string;
  title?: string;
};

/** Figma: Arrow / Arrows_Reload_01 */
export function ArrowsReload({
  size = 24,
  title,
  className = "",
  ...rest
  ...
  return (
    <svg
      ...
      className={`pw-icon pw-icon--arrows-reload ${className}`.trim()}
