// url=https://www.figma.com/design/o92QFaFLrva3a3JJ0YS5Qp/Palletways-v1.2?node-id=277-616
// source=https://github.com/stevierodger/palletways-web/blob/main/src/components/Button/Button.tsx
// component=Button
// figma=button-secondary-lg → variant="secondary" size="lg"
